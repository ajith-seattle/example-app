...
<div class="item-action" >
                                    <a class="list-item btn btn-primary" href="/states/create" >
                                    {{ __('Create State') }}
        ...
        <tr>
            ...
            <td>
                <form action="{{ route('states.destroy',$state->id) }}" method="POST">
                    <a  href="{{ route('states.edit',$state->id) }}"><span><svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
