...
<div class="item-action" >
                                    <!-- <a class="list-item btn btn-primary" href="/companies" >
                                    {{ __('Manage Company') }}

                                    </a> -->
                                    <a class="list-item btn btn-primary" href="/companies/create" >
                                    {{ __('Create Company') }}
        ...
        <tr>
            ...
            <td>
                <form action="{{ route('companies.destroy',$company->id) }}" method="POST">
                    ...
                    <a  href="{{ route('companies.edit',$company->id) }}"><span><svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
