...
<div class="item-action" >
                                    <a class="list-item btn btn-primary" href="/purchasecategories/create" >
                                    {{ __('Create Purchase') }}
        ...
        <tr>
            ...
            <td>
                <form action="{{ route('purchasecategories.destroy',$purchasecategory->id) }}" method="POST">
                    <a  href="{{ route('purchasecategories.edit',$purchasecategory->id) }}"><span><svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
