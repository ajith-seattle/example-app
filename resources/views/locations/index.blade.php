...
<div class="item-action" >
                                    <!-- <a class="list-item btn btn-primary" href="/locations" >
                                    {{ __('Manage Location') }}

                                    </a> -->
                                    <a class="list-item btn btn-primary" href="/locations/create" >
                                    {{ __('Create Location') }}
        ...
        <tr>
            ...
            <td>
                <form action="{{ route('locations.destroy',$location->id) }}" method="POST">
                    ...
                    <a  href="{{ route('locations.edit',$location->id) }}"><span><svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
