...
<div class="item-action" >
                                    <a class="list-item btn btn-primary" href="/projects/create" >
                                    {{ __('Create Project') }}
                                    </a>
        ...
        <tr>
            ...
            <td>
                <form action="{{ route('projects.destroy',$project->id) }}" method="POST">
                    <a  href="{{ route('projects.edit',$project->id) }}"><span><svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
